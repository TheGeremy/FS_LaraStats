...
{
    /**
     * Holds all bunker silos from items.xml of savegame folder
     *
     * @return void
     */
    public function up()
    {
        ...
        DB::statement("ALTER TABLE `$tableName` comment 'Holds all bunker silos from items.xml of savegame folder'");
    }
