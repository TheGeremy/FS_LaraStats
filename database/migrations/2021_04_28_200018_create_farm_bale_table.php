...
{
    /**
     * Holds each bale from items.xml fo savegame folder
     * 
    ...
    public function up()
    {
        ...
        DB::statement("ALTER TABLE `$tableName` comment 'Holds each bale from items.xml fo savegame folder'");
    }
