...
{
    /**
     * Information about manure module of each husbandry from items.xml of savegame folder
     *
     * @return void
     */
    public function up()
    {
        $tableName = 'fs_husbandry_manure';
        ...
        DB::statement("ALTER TABLE `$tableName` comment 'Information about manure module of each husbandry from items.xml of savegame folder'");
    }
