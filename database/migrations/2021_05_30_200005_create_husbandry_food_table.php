...
{
    /**
     * Information about food module of each husbandry from items.xml of savegame folder
     *
     * @return void
     */
    public function up()
    {
        $tableName = 'fs_husbandry_food';
        ...
        DB::statement("ALTER TABLE `$tableName` comment 'Information about food module of each husbandry from items.xml of savegame folder'");
    }
