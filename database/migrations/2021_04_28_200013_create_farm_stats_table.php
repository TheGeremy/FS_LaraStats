...
{
    /**
     * Information about farm other non financial stats from savegame folder and farms.xml
     *
     * @return void
     */
    public function up()
    {
        $tableName = 'fs_farm_stat';
        ...
        DB::statement("ALTER TABLE `$tableName` comment 'Information about farm other non financial stats from savegame folder and farms.xml'");
    }
